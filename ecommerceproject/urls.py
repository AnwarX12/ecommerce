...
urlpatterns = [
    ...
    path('', ec.index),
    path('items/', ec.listitems,name='listitems'),  #url in cup
    path('detials/<int:id>', ec.detials,name='detials'),   #url in detail product
    path('listitemsC/', ec.listitemsC,name='listitemsC'),
    path('listitemsM/', ec.listitemsM,name='listitemsM'),
